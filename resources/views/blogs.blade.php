            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <div class="flex flex-col items-center">
                    <span class="text-sm text-gray-700 dark:text-gray-400">
                        Showing <span class="font-semibold text-gray-900 dark:text-white" id="start-index">1</span> to
                        <span class="font-semibold text-gray-900 dark:text-white" id="end-index">10</span> of <span
                            class="total-pages font-semibold text-gray-900 dark:text-white"></span> Entries
                    </span>
                    </span>

                    <nav aria-label="Page navigation example">
                        <ul class="page flex items-center -space-x-px h-10 text-base">
                            <li>
                                <a href="#"
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                for (let i = startIndex; i < endIndex; i++) {
                                    const blog = response.data[i];
                                    $('#categories-table tbody').append(`
                            <tr data-id="${blog.id}" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                <td class="px-6 py-4">${blog.id}</td>
<td class="px-6 py-4">${blog.title}</td>
<td class="px-6 py-4">${blog.subcategory.title}</td>
<td class="px-6 py-4">${blog.category}</td>
                                ...
                                <td class="text-right px-6 whitespace-nowrap">
                                    ...
                                    <button id="delete-category" data=${blog.id} class="delete-category py-2 leading-none px-3 font-medium text-red-600 hover:text-red-500 duration-150 hover:bg-gray-50 rounded-lg">Delete</button>
                                </td>
                            </tr>
                        `);
                                }
